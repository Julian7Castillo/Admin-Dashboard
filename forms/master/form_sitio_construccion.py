...
class FormularioSitioConstruccionDesign():
    ...
    def __init__(self, panel_principal, logo):
        ...
        self.labelTitulo = tk.Label(self.barra_superior, text = " Pagina en cosntrucción")
        self.labelTitulo.config(fg = "#222d33", font=("Roboto", 30), bg=COLOR_CUERPO_PRINCIPAL)
        self.labelTitulo.pack(side=tk.TOP, fill="both", expand=True)
        
        self.label_Imagebn = tk.Label(self.barra_inferior, image=logo)
        self.label_Imagebn.place(x = 0, y = 0, relwidth=1, relheight=1)
        self.label_Imagebn.config(fg = "#fff", font=("Roboto", 10), bg=COLOR_CUERPO_PRINCIPAL)
